...
%\label{sec:DFER}
%\centering
\includepdf[pages=-,scale=0.8,offset=-25 -25,pagecommand={\section*{\raggedright Attachment 2 - DFER Approval to Conduct Research}}]{DFER_email.pdf}
\includepdf[pages=-,scale=0.8,offset=-25 -25,pagecommand={\section*{\raggedright Attachment 3 - USAFA Judge Advocate Approval to Conduct Research}}]{email.pdf}
%\label{sec:JA}
